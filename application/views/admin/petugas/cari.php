<div class="panel panel-default">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			...
			</span> &nbsp <a href="<?php echo site_url('petugas');?>"> Petugas </a>  
			<span class="glyphicon glyphicon-chevron-right"/>
			</span> &nbsp <a href="<?php echo site_url('petugas/cari');?>"> Cari </a> 
		</h4>
    </div>
	...
	<div class="well well-sm">
		...
		<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('petugas/cari');?>" method="post">
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="masukkan user" name="cari">
			</div>
